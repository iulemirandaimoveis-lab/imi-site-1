    ...
    return (
        <div className="bg-white">
            ...
            <div className="bg-neutral-50 border-b border-neutral-200">
                <div className="container-custom hero-padding !pb-4">
                    <nav className="flex items-center gap-2 text-sm">
                        <Link href="/" className="text-neutral-500 hover:text-navy-700">Home</Link>
                        <span className="text-neutral-400">/</span>
                        <Link href="/imoveis" className="text-neutral-500 hover:text-navy-700">Imóveis</Link>
                        <span className="text-neutral-400">/</span>
            ...
            <section className="bg-neutral-100">
                <div className="container-custom py-6 lg:py-8">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        {/* Imagem Principal */}
                        <div className="lg:col-span-2 relative h-[350px] md:h-[450px] lg:h-[500px] rounded-xl overflow-hidden shadow-lg">
                            {primaryImage ? (
                                <Image
                            ...
                            <div className="absolute top-4 left-4 flex flex-col gap-2">
                                ...
                                {property.technicalAnalysisAvailable && (
                                    <Badge variant="info" className="bg-navy-600">Análise técnica disponível</Badge>
                                )}
                        ...
                        <div className="lg:col-span-1">
                            <div className="sticky top-28 bg-white border border-neutral-200 rounded-xl p-6 shadow-soft">
                                ...
                                <div className="space-y-3">
                                    <a
                                        href={`https://wa.me/5581997230455?text=Olá! Tenho interesse no imóvel: ${property.title}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="w-full flex items-center justify-center gap-2 bg-navy-900 hover:bg-navy-800 text-white font-semibold py-4 px-4 rounded-xl shadow-lg transition-all active:scale-[0.98]"
                                    >
