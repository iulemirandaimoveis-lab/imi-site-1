...
export function HeroSection() {
    return (
        <section className="relative min-h-[90dvh] flex items-center bg-navy-900 text-white section-padding overflow-hidden">
            {/* Background pattern */}
            ...
            <div className="container-custom relative z-10 w-full">
                <div className="max-w-4xl">
                    ...
                    <motion.div
                        ...
                        className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-3 rounded-full text-gold-500 text-sm font-semibold mb-8 backdrop-blur-sm"
                    >
                    ...
                    >
                        Estrutura jurídica sólida, gestão profissional e crédito inteligente para investidores brasileiros que buscam proteção patrimonial e rentabilidade em USD.
                    </motion.p>
                    ...
                    <motion.div
                        ...
                        className="mt-16 flex flex-wrap gap-8 text-slate-400 text-sm"
                    >
                        {[
                            '+$50M Alocados',
                            '200+ Investidores',
