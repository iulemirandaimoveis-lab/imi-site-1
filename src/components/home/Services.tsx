            ...
            <div className="container-custom">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div className="group p-8 rounded-xl bg-white border border-slate-100 shadow-soft hover:shadow-card-hover transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <h3 className="text-xl font-bold text-navy-900 mb-3 font-display">{dict.card_appraisals_title}</h3>
                    ...
                    <div className="group p-8 rounded-xl bg-white border border-slate-100 shadow-soft hover:shadow-card-hover transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <h3 className="text-xl font-bold text-navy-900 mb-3 font-display">{dict.card_consulting_title}</h3>
                        <p className="text-slate-600 leading-relaxed text-sm">
                    ...
                    <div className="group p-8 rounded-xl bg-white border border-slate-100 shadow-soft hover:shadow-card-hover transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <h3 className="text-xl font-bold text-navy-900 mb-3 font-display">{dict.card_brokerage_title}</h3>
                        <p className="text-slate-600 leading-relaxed text-sm">
