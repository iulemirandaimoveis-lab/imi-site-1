// IMI - Sistema de Ícones Exclusivos
// Ícones SVG inline para performance e customização
...
const IMIIcons = {
    ...
    bath: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M9 6 6.5 3.5a1.5 1.5 0 0 0-1 0c-.9.4-1.5 1.2-1.5 2.1v0c0 .6.4 1.2.9 1.5L7 9"/>
...
// Função helper para inserir ícones
function getIcon(name, className = '', size = 24) {
    const icon = IMIIcons[name];
    if (!icon) return '';

    const wrapper = document.createElement('span');
    wrapper.className = `imi-icon ${className}`;
